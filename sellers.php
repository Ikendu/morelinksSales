            ...
            <div class="mainpage">
                <div class="sellermain">
                    ...
                    <form id="interestForm" method="POST" action="submit.php">
                        ...
                        <input type="text" name="furniture_type" placeholder="Furniture Types (e.g., Sofas, Beds) seperate with comma" />
                        <input type="text" name="city" placeholder="City / Location" />
                        <textarea name="message" placeholder="Your message (optional)"></textarea>
                        <label class="checker"><input type="checkbox" required /> I want to be contacted about selling my furniture.</label>
